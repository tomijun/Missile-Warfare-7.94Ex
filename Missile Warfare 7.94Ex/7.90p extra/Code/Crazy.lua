...
for i = 0, 3 do -- 클지 1팀
    ...
    Trigger {
        players = {i},
        conditions = {
            Void(7+i,AtLeast,1); Void(7+i,AtMost,227*2-1);
    ...
    if i == 0 then
        NIf(i,{Switch("Switch 85",Set),Void(7+i,AtLeast,1,0),Void(7+i,AtMost,335,0)})
                DoActionsX(i,{
    ...
    if i == 4 then
        NIf(i,{Switch("Switch 86",Set),Void(7+i,AtLeast,1,0),Void(7+i,AtMost,335,0)})
                DoActionsX(i,{
